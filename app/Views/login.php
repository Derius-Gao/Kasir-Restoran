            ...
            <section class="login-area pb-100">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                            ...
                            <form action="#">
                                <label for="username">Email Address <span>**</span></label>
                                  <input type="username" class="form-control" id="username" placeholder="Enter email" name="email" required>
                                <label for="pass">Password <span>**</span></label>
                                 <input type="password" class="form-control" id="password" placeholder="Enter Password" name="password" required>
                                      <div class="g-recaptcha" data-sitekey="6LcTh-8qAAAAADT6IB3IC66iKZGTm5Un7fZzp5K9">
                    </div>
                    <button type="submit" class="t-y-btn w-100">Login Now</button>
                                ...
                                <a href="<?=base_url('home/forgot_password')?>" class="t-y-btn t-y-btn-grey w-100">Forgot Password</a>
                                <a href="<?=base_url('home/register')?>" class="t-y-btn t-y-btn-grey w-100">Register Now</a>
                            </form>
                            </div>
                    </div>
                </div>
